...
extension UIViewController {
    func addChildViewControllerWithView(childViewController: UIViewController, toView view: UIView? = nil) {
...
//        if let ratingVC = storyboard.instantiateViewController(withIdentifier: "RatingVC") as? RatingVC {
//            self.ratingVC = ratingVC
//            self.addChildViewControllerWithView(childViewController: ratingVC as UIViewController,toView: self.view)
//            self.ratingVC.view.isHidden = true
//        }
...
//        self.ratingVC.view.isHidden = false
//        let storyboard = UIStoryboard(name: "Main", bundle: nil)
